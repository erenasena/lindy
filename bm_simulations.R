...
moment_plot <- function(data){
  ...
  ############################################## ############################################## # CV and Skewness functions coefvar=function(data){
...
############################################## # Preparation of the plot ############################################## # Paretian Area
  ############################################## # Paretian Area
...
# Fit a distribution with various method (this is not very informative)
...
fit <- Fwindow(object = surv_fit, width = 100, variance = TRUE, conf.level = 0.95)
